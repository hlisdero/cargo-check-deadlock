...
fn minimal_function_call_generates_correct_dot_output_file() {
    assert_output_file(
        ...
        "dot",
        "./net.dot",
        "./tests/sample_results/minimal_function_call/net.dot",
    );
}
...
fn minimal_function_call_generates_correct_lola_output_file() {
    assert_output_file(
        ...
        "lola",
        "./net.lola",
        "./tests/sample_results/minimal_function_call/net.lola",
    );
}
...
fn minimal_function_call_generates_correct_pnml_output_file() {
    assert_output_file(
        ...
        "pnml",
        "./net.pnml",
        "./tests/sample_results/minimal_function_call/net.pnml",
    );
}
