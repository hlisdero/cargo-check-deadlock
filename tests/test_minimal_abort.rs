...
fn minimal_abort_generates_correct_dot_output_file() {
    assert_output_file(
        "./examples/programs/minimal_abort.rs",
        "dot",
        "./net.dot",
        "./examples/results/minimal_abort/net.dot",
    );
}
...
fn minimal_abort_generates_correct_lola_output_file() {
    assert_output_file(
        ...
        "lola",
        "./net.lola",
        "./examples/results/minimal_abort/net.lola",
    );
}
...
fn minimal_abort_generates_correct_pnml_output_file() {
    assert_output_file(
        ...
        "pnml",
        "./net.pnml",
        "./examples/results/minimal_abort/net.pnml",
    );
}
