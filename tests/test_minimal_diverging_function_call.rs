...
fn minimal_diverging_function_call_generates_correct_dot_output_file() {
    assert_output_file(
        "./examples/programs/minimal_diverging_function_call.rs",
        "dot",
        "./net.dot",
        "./examples/results/minimal_diverging_function_call/net.dot",
    );
}
...
fn minimal_diverging_function_call_generates_correct_lola_output_file() {
    assert_output_file(
        ...
        "lola",
        "./net.lola",
        "./examples/results/minimal_diverging_function_call/net.lola",
    );
}
...
fn minimal_diverging_function_call_generates_correct_pnml_output_file() {
    assert_output_file(
        ...
        "pnml",
        "./net.pnml",
        "./examples/results/minimal_diverging_function_call/net.pnml",
    );
}
